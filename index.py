...
class Main(QMainWindow, MainUI) :
    ...
    def db_connect(self) :
        ...
        self.db = MySQLdb.connect(host = 'localhost' ,user = 'root' ,
                                  password = '',db = 'DeirQaddis_library')
...
#####################Book############################
    ...
    def add_new_book(self) :
        try:
           ...
           self.book_add_label.setText(f'Invalid Operation') 
    ...
    def edit_book_search(self) :
        ...
        try : 
            ...
            self.book_editsrch_label.setText('ERROR : Invalid Operation')
...
####################Number of main page####################
    ...
    def total_sales_today(self) : 
        ...
        label = f'Overall Sales For This Day is : {overall_sales} $'
        self.announce_label.setText(str(label))
